...
void PlayerAttackStateBase::AttackCommonUpdate()
{
	...
	//çUåÇÇÃéûÇ…âÒîçsìÆÇÇ¢ÇÍÇΩÇÁâÒîèÛë‘Ç…à⁄çs
	...
	EnemyRotation();
	//çUåÇÇÃéûÇ…éüÇÃÉ{É^ÉìÇ™âüÇ≥ÇÍÇƒÇ¢ÇΩÇÁéüÇÃçUåÇ

	//ìñÇΩÇËîªíËÇ™Ç†ÇÈä‘ÇÕÉXÉsÅ[ÉhÇëÅÇ≠
	if (collsion) {
		if (beforeAttack) {
			AttackMoveStart();
		}
