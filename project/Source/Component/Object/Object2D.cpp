...
void Object2D::Init(const VECTOR2F& _pos, const VECTOR2F& _rotate, const VECTOR2F& _scale, const std::string& name)
{
...
void Object2D::Init(const Transform& _transform, const std::string& name)
{
