...
void EnemyManager::CreateBoss()
{
	...
	anim->AddFile(ID::B_N_ATTACK4, "B_ATTACK4", false,1.3f,20.0f,55.0f);
	anim->AddFile(ID::B_N_ATTACK5, "B_ATTACK5", false,1.3f,20.0f,55.0f);
	anim->AddFile(ID::B_N_ATTACK6, "B_ATTACK6", false,1.3f,50.0f,65.0f);
